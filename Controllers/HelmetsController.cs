...
namespace HeraldsHelmets.Controllers
{
    public class HelmetsController : Controller
    {
        private readonly MvcHelmetContext _context;

        public HelmetsController(MvcHelmetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Size,Brand,Model,Colour,Price,Rating")] Helmet helmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Size,Brand,Model,Colour,Price,Rating")] Helmet helmet)
        {
            if (id != helmet.Id)
            {
                return NotFound();
